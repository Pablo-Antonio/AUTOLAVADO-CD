      ...
      $.ajax({
        ...
        .done(function (data) {
          ...
          if (datos[0].ventas == 0) {
            ...
            $("#viewCantidad").text(datos[0].ventas);
            $("#viewTotal").text(datos[0].total);
      ...
      $.ajax({
        ...
        .done(function (data) {
          ...
          if (datos[0].ventas == 0) {
            ...
            $("#viewCantidadRep").text(datos[0].ventas);
            $("#viewTotalRep").text(datos[0].total);
