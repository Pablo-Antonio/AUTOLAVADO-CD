...
function getUsuarios() {
  $.ajax({
    method: "get",
    url: "/apiDashboard/getUsers",
  })
    .done(function (data) {
      //console.log(data);
      var datos = JSON.parse(data);
      $("#usrVig").text(datos[0].usuarios);
    })
    .fail(function () {
...
function getServicios() {
  $.ajax({
    method: "get",
    url: "/apiDashboard/getServicios",
  })
    .done(function (data) {
      //console.log(data);
      var datos = JSON.parse(data);
      $("#serVig").text(datos[0].servicios);
    })
    .fail(function () {
      msjAlert("error", "Error con el Servidor", "Error");
    });
...
function getVentas() {
  $.ajax({
    method: "get",
    url: "/apiDashboard/getVentas",
  })
    .done(function (data) {
      //console.log(data);
      var datos = JSON.parse(data);
      $("#ventas").text(datos[0].ventas);
    })
    .fail(function () {
      msjAlert("error", "Error con el Servidor", "Error");
    });
...
function getIngresos() {
  $.ajax({
    method: "get",
    url: "/apiDashboard/getIngresos",
  })
    .done(function (data) {
      //console.log(data);
      var datos = JSON.parse(data);
      var ingresos = datos[0].ingresos == null ? 0 : datos[0].ingresos;
